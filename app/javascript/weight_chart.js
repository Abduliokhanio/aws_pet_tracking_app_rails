...
(function() {
  function initWeightChart() {
    console.log('Weight chart init, Chart available:', typeof Chart !== 'undefined');
  ...
  document.addEventListener('turbo:load', initWeightChart);
  document.addEventListener('turbo:render', initWeightChart);
})();
