...
(function() {
  function initHealthMetrics() {
    console.log('Health metrics init, Chart available:', typeof Chart !== 'undefined');
    
    // Wait for Chart.js to be available
    if (typeof Chart === 'undefined') {
      console.log('Chart not ready for health metrics, waiting...');
      setTimeout(initHealthMetrics, 100);
      return;
    }
    ...
    if (moodCanvas) {
      ...
      if (metricsData.mood) {
        ...
        console.log('Mood chart created');
      }
    }
    ...
    if (foodCanvas) {
      ...
      if (metricsData.food_intake) {
        ...
        console.log('Food intake chart created');
      }
    }
  }
  ...
  document.addEventListener('turbo:load', initHealthMetrics);
  document.addEventListener('turbo:render', initHealthMetrics);
})();
